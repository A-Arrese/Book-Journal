...
public class Ebook extends BaseBook {
    public Ebook(int id, String title, String author, Genre genre, int duration, String coverImage) {
        super(id, title, author, genre, duration, BookFormat.EBOOK, coverImage);
    }
